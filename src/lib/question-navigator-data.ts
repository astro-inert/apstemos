...
export const QN_UNITS: UnitEntry[] = [
  ...
  },
  {
    ...
    weight: "4–7%",
    blurb: "Definition of the derivative and fundamental differentiation rules.",
    topics: [
      { slug: "definition-of-the-derivative", title: "Definition of the Derivative", blurb: "Average rate, derivative definitions, tangent slopes, and numerical estimates." },
      { slug: "power-rule", title: "Basic Derivative Rules", blurb: "Power, constant, sum, difference, and constant-multiple rules." },
      { slug: "product-and-quotient-rules", title: "Product & Quotient Rules", blurb: "Recognize, execute, and verify product and quotient derivatives." },
