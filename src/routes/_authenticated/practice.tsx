    ...
    >
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_0.75fr_auto]">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 rounded-md border border-border bg-card px-4 py-2.5 text-[13px] font-medium transition-colors hover:border-primary/40"
        >
      ...
      <div className="mt-6">
        {isLoading ? (
          ...
          <div className="rounded-3xl border border-dashed border-border p-12 text-center text-[14px] text-muted-foreground">
           ...
           <div className="space-y-5 rounded-lg border border-border bg-card p-6 sm:p-8">
                ...
                return (
                  <button
                    ...
                    onClick={() => setChoice(c.label)}
                     className={`flex w-full items-start gap-3 rounded-md border px-4 py-3 text-left text-[14px] transition-colors ${
                      isAnswer
            ...
            {!feedback ? (
              <button
                ...
                disabled={submit.isPending || !choice}
                 className="rounded-md bg-primary px-5 py-2.5 text-[14px] font-semibold text-primary-foreground transition-opacity disabled:opacity-50"
              >
              ...
              <div className="space-y-4 border-t border-border pt-5">
                ...
                {feedback.explanation && (
                   <div className="text-[14px] leading-relaxed text-secondary-foreground">
