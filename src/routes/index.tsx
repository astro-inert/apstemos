...
const features = [
  ...
  { to: "/latex-master-sheet", eyebrow: "Cram", title: "Master Sheet", desc: "Save this 10-page LaTeX-formatted comprehensive, topic-organized sheet to review all the important formulas you need a week before your exam.", color: "#ea580c", bg: "#fff7ed", border: "#fed7aa" },
