  ...
  return (
    <div className="min-h-screen bg-background text-foreground grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 border-r border-border bg-card relative overflow-hidden">
        ...
        <Link to="/" className="relative flex items-center gap-2 font-display text-base font-bold">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          <Link to="/" className="lg:hidden inline-flex items-center gap-2 font-display text-base font-bold mb-8">
            <span className="grid place-items-center h-7 w-7 rounded-md bg-primary text-primary-foreground">
              <Sigma className="h-4 w-4" strokeWidth={2.5} />
            </span>
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-semibold hover:bg-elevated transition disabled:opacity-50"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition disabled:opacity-50"
            >
